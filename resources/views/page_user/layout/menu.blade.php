    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active"><a href="{{ route('home') }}" class="nav-link">{{ __('text.Home') }}</a></li>
                <li class="nav-item"><a href="about.html" class="nav-link">{{ __('text.About') }}</a></li>
                <li class="nav-item"><a href="{{ route('tours') }}" class="nav-link">{{ __('text.Tours') }}</a></li>
                <li class="nav-item"><a href="{{ route('hotels') }}" class="nav-link">{{ __('text.Hotels') }}</a></li>
                <li class="nav-item"><a href="{{ route('news') }}" class="nav-link">{{ __('text.News') }}</a></li>
                <li class="nav-item"><a href="contact.html" class="nav-link">{{ __('text.Contact') }}</a></li>
            </ul>
        </div>
    </div>
