...
<html class="no-js h-100" lang="en">
    <head>
        ...
        <link rel="stylesheet" id="main-stylesheet" data-version="1.1.0" href="{{ asset('source_admin/styles/shards-dashboards.1.1.0.min.css') }}">
        <link rel="stylesheet" href="{{ asset('source_admin/styles/extras.1.1.0.min.css') }}">
